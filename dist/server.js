...
var require_DiskStorage = __commonJS({
  "src/providers/DiskStorage.ts"(exports, module2) {
    ...
    var fs = require("fs");
    var path2 = require("path");
    var uploadConfig3 = require_upload();
    var DiskStorage = class {
      async saveFile(file) {
        await fs.promises.rename(
          path2.resolve(uploadConfig3.TMP_FOLDER, file),
          path2.resolve(uploadConfig3.UPLOADS_FOLDER, file)
        );
        return file;
      }
      async deleteFile(file) {
        const filePath = path2.resolve(uploadConfig3.UPLOADS_FOLDER, file);
        try {
...
app.use("/files", import_express11.default.static(uploadConfig2.UPLOADS_FOLDER));
app.use(cors());
