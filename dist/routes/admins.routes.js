...
var admins_routes_exports = {};
__export(admins_routes_exports, {
  default: () => admins_routes_default
});
module.exports = __toCommonJS(admins_routes_exports);
...
// src/routes/admins.routes.ts
var adminsRoutes = (0, import_express.Router)();
